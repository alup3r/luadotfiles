...
# JAVA_HOME Amazon Correto 17
export JAVA_HOME=/Library/Java/JavaVirtualMachines/amazon-corretto-17.jdk/Contents/Home

# Midway
alias minit='ssh-add -D && mwinit && ssh-add && mwinit --itar && ssh-add && scp ~/.midway/cookie dev-dsk-aluper-1d-e5041135.us-east-1.amazon.com:~/.midway/cookie && mwinit --ssh-public-key ~/.ssh/id_ecdsa.pub'
...
__conda_setup="$('/Users/aluper/Applications/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/aluper/Applications/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/aluper/Applications/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/aluper/Applications/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
